...
var zescape = function zescape(html, encode) {
...
Renderer.prototype.code = function renCode(code, lang, escaped) {
    ...
    return '<pre><code class="' + this.options.langPrefix + zescape(lang, true) + '">' + (escaped ? code : zescape(code, true)) + '\n</code></pre>\n';
};
...
var renHtml = function renHtml(html) {
    return html;
};
...
Renderer.prototype.tocItem = function tocItem(id, level, text) {
    ...
    return '<li class="toc-item toc-level-' + level + '"><a class="toc-link" href="#' + zescape(id) + '"><span class="toc-number"></span><span class="toc-text">' + text + '</span></a>';
};
Renderer.prototype.emoji = function emoji(emojiName) {
    var title = ':' + zescape(emojiName) + ':';
...
var rulesInline = __webpack_require__(28);
...
var blockFun = __webpack_require__(19);
var sortRules = __webpack_require__(8);
var merge = __webpack_require__(1);
...
var defaults = __webpack_require__(0);
var tokenParser = __webpack_require__(29);
...
var _tag = '(?!(?:' + 'a|em|strong|small|s|cite|q|dfn|abbr|data|time|code' + '|var|samp|sub|sup|b|u|mark|ruby|rt|rp|bdi|bdo' + '|span|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b';

inline.html = replace(inline.html)('comment', /<!--[\s\S]*?-->/)('closed', /<(tag)[\s\S]+?<\/\1>/)('closing', /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, _tag)();
...
var newline = __webpack_require__(22);
var toc = __webpack_require__(27);
var code = __webpack_require__(13);
var fences = __webpack_require__(15);
var heading = __webpack_require__(16);
var nptable = __webpack_require__(23);
var lheading = __webpack_require__(20);
var hr = __webpack_require__(17);
var blockquote = __webpack_require__(12);
...
function emoji(state, env) {
    var cap = env.rules.emoji.exec(state.src);
    if (cap) {
        state.src = state.src.substring(cap[0].length);
...
var _rules = [
// ['newline', newline, 10],
['emoji', emoji, 20], ['html', html, 30], ['escape', ruleEscape, 40], ['autolink', autolink, 50], ['url', url, 60], ['tag', tag, 70], ['link', link, 80], ['refnolink', refnolink, 90], ['strong', strong, 100], ['em', em, 110], ['code', code, 120], ['br', br, 130], ['del', del, 140], ['text', text, 150]];
module.exports = _rules;
...
function marked(src, opt, callback) {
    if (callback || typeof opt === 'function') {
        ...
        var highlightHandle = function highlightHandle(token) {
