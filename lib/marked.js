...
Renderer.prototype.toc = function renToc(items) {
    var html = '<div class="toc">' + items + '</div>';
    return html;
};
...
var _tag = '(?!(?:' + 'a|em|strong|small|s|cite|q|dfn|abbr|data|time|code' + '|var|samp|sub|sup|b|u|mark|ruby|rt|rp|bdi|bdo' + '|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b';
...
var _rules = [['newline', newline, 10], ['emoji', emoji, 20], ['html', html, 30], ['escape', ruleEscape, 40], ['autolink', autolink, 50], ['url', url, 60], ['tag', tag, 70], ['link', link, 80], ['refnolink', refnolink, 90], ['strong', strong, 100], ['em', em, 110], ['code', code, 120], ['br', br, 130], ['del', del, 140], ['text', text, 150]];
module.exports = _rules;
